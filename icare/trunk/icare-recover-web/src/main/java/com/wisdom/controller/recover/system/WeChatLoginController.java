package com.wisdom.controller.recover.system;
    ...
    public ModelAndView login(Model model, @RequestParam(value = "code", required = false) String code, @RequestParam("state") String state,
        ...
        try {
            if(logger.isDebugEnabled()) {
                ...
                logger.debug("type:" + SysParamDetailConstant.ACCOUNT_TYPE_RECOVER);
            }
...
//                return new ModelAndView("redirect:/");
            ...
            WeChatLogin weChatLogin = weChatLoginService.login(code, SysParamDetailConstant.ACCOUNT_TYPE_RECOVER, request);
            ...
            return new ModelAndView("redirect:/recover/success");
