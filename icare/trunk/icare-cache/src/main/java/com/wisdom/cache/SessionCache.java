...
public class SessionCache {
    ...
    public Object get(Object key) {
        ...
        Object object;
        object = sessionRedisTemplate.execute(new RedisCallback<Object>() {
    ...
    public void put(Object key, Object value, final long liveTime) {
        ...
        sessionRedisTemplate.execute(new RedisCallback<Long>() {
    ...
    public void clear() {
        sessionRedisTemplate.execute(new RedisCallback<String>() {
